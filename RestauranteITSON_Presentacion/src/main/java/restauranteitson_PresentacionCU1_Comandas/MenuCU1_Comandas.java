 ...
 * @author abrilislas
 */
public class MenuCU1_Comandas extends javax.swing.JFrame {

    /**
     * Creates new form MenuCU1_Comandas
     */
    public MenuCU1_Comandas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCU1_Comandas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCU1_Comandas().setVisible(true);
            }
        });
    }
